...
/*                            initFile
     ...
     Role : initialise la structure file (retourne NULL si echec)
...
/*                            enfiler
     ...
     Condition NECESSAIRE : la file ne doit pas être pleine
     ...
     Sous fonctions : -                                                   */
/* -----------------------------------------------------------------------*/
void enfiler(file_t * file, element val){
...
/*                            defiler
     ...
     CONDITION NECESSAIRE : file non vide
...
element sommetF(file_t * file){
     return (file->base)[file->deb];									// L'élément au sommet de la pile
}
